...
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 1. See the whole dataset</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 2. Get column names, data types info</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 3. Get the count and percentage of NA values</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 4. Get descriptive analysis </p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 5. Check inbalance or distribution of target variable:</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 6. See distribution of numerical columns</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 7. See count plot of categorical columns</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 8. Get outlier analysis with box plots</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100% ; color:Blue;font-family:Courier;">&nbsp 9. Obtain info of target value variance with categorical columns</p>', unsafe_allow_html=True)
#st.image('header2.png', use_column_width = True)

functions.space()
st.write('<p style="font-size:140% ; color:Green;font-family:Courier;">Import Dataset</p>', unsafe_allow_html=True)
...
if dataset:
    ...
    n, m = df.shape
    st.write(f'<p style="font-size:130%;color:Red;font-family:Tangerine">Dataset contains {n} rows and {m} columns.</p>', unsafe_allow_html=True)   
    st.dataframe(df)
    ...
    if 'Info' in vizuals:
        ...
        #c3.dataframe(functions.df_info(df))
